...
internal static class AoC_2022_4b
{
	...
	{
		// Only changes compared to 4a are here
		var range1ContainedInRange2 = range1.start >= range2.start && range1.start <= range2.end;
		var range2ContainedInRange1 = range2.start >= range1.start && range2.start <= range1.end;
